...
feature 'Remove question', %q{
  The author can delete his questions
} do
  ...
  scenario 'An unauthenticated does not see the link to remove the question' do
    visit question_path question

    expect(page).to_not have_content 'Удалить вопрос'
  end

  scenario 'Not the author does not see the link to remove the question' do
